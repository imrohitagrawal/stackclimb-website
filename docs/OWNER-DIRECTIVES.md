...
| # | Directive | Status | Where it lives |
|---|---|---|---|
| P-1 | Recapture PRODUCT.md — full re-interview | **PARTIAL — staleness confirmed and detailed 08-18, still no work started on the fix** | Users/purpose/positioning updated; evidence section stale in two concrete places: `PRODUCT.md:157` and `:171` still say **"self-reported"**, the exact word `AGENTS.md`'s voice rule retired 2026-08-14 (RCA-002) in favour of "approximate" plus attribution — the built site already honours the fix everywhere (0 occurrences, gated in `tests/proof-act.spec.js`), `PRODUCT.md` does not; `PRODUCT.md:58` still describes SaafSaans readings as "live, deterministic, or sample" — SAMPLE was deleted from the product 08-12 (D74), the real states are LIVE / CACHED / NO READING |
