# Cross-cutting engineering practice — index

The strongest site material is not in any single project; it is the practice visible *across*
them. Four findings, one file each.
...
Status legend and method: [`../README.md`](../README.md).
