...
| `src/assets/projects/saafsaans-crop.webp` | crop of the above — the app's header row (wordmark in English and Hindi, Today/City Pulse/System/Guide, the Day/Night and English/हिंदी toggles), the shared-sky line (`ANAND VIHAR · LIVE · 5:00 PM · AQI 270 · POOR`), the persona line, headline and both score chips, 1212×388. **Re-cut 2026-08-27 (D135) on the owner's ruling** — he asked for the header row back; it had been a 728×228 strip without it for one day (D130). **Re-cut 2026-08-26 (DEF-70):** it was a 900×267 phone crop served below 700px; the home plate now shows it at every width (`homeCrop`), because the full capture rendered at 0.30 of its size in the desktop column. The project page still shows the full capture above 700px |
