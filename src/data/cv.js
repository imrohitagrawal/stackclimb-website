...
export const awards = [
  /* Added 2026-08-27 (D146) on the owner's word. Provenance: a dated certificate of achievement
     ...
     a recruiter needs. The certificate itself is NOT committed: this repository is public and
     that is a personal document. */
  'Anthropic Claude Community Impact Lab hackathon (Bengaluru, August 2026) — runner-up, Superhuman Lab: AI × Hardware for Assistive Tech',
