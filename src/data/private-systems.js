 ...
 *
 * EvalAxis's figure traces to docs/evidence/projects/private.md:19-26,
 * audited at citevyn-sibling commit c3233de: both commands reproduce exactly
 * (13,769 lines · 388 `def test_` functions; `--collect-only` gives 426 after
 * parametrisation — a different metric, deliberately not quoted here).
...
export const privateSystems = {
  evalaxis: {
    ...
    figure: '13,769 lines · 388 test functions',
  },
  aegis: {
